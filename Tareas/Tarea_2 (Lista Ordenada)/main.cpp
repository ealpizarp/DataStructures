...
cout<<"--------------------------------------------------------------------------"<<endl;
    ...
    cout<<"A que posicion desea ir? "; cin>>opc;
     ...
     cout<<"La posicion de el numero es: "<<arl.indexOf(opc)<<endl;
     }
     ...
     List<int> *arl1 = new ArrayList<int>(opc);
...
system("PAUSE");
   ...
   LinkL.print();
   cout<<endl;
    List<int> * LinkL1 = new LinkedList<int>();
...
bool band;
cout<<"Ahora vamos a crear una lista ordenada, seleccione una opcion: "<<endl;
cout<<"Array List ordenada                      1"<<endl;
cout<<"Linked List ordenada                     2"<<endl;
do{
cin>>opc;

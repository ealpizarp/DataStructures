...
int main()
{
    ...
    text.cargarPalabrasIgnorar("Ignore.txt");
    text.CargarPalabrasMasUtilizadas();
    //text.imprimirArchivo();
    //text.cargarArchivo("Quijote.txt");
    text.mostrarPalabrasPorProfundidad(3);
    cout<<"Estas son las 50 palabras mas utilizadas en el texto"<<endl;
    text.palabrasMasUtilizadas(50);
    //text.agregarPalabraIgnorar("OneDay");
    cout << "Estas son las 50 palabras menos utilizadas en el texto" <<endl;
    text.palabrasMenosUtilizadas(50);
    //text.eliminarPalabrasIgnorar();
    //text.agregarPalabraIgnorar("OneDay");
